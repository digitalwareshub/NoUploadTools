...
const organizationSchema = {
  ...
  description:
    "Privacy-first browser utilities for file conversion and processing without uploads",
  sameAs: []
};
...
const websiteSchema = {
  ...
  url: siteUrl,
  description:
    "Convert images to PDF and use other privacy-first tools without uploading files",
  potentialAction: {
    "@type": "SearchAction",
    target: {
      "@type": "EntryPoint",
      ...
      <div className="space-y-8">
        ...
        <section className="space-y-3 text-base text-gray-700">
          ...
          <p>
            ...
            work. Students, freelancers, lawyers, doctors and government
            officers all rely on small tools to convert, compress or clean files
            before uploading them somewhere else. The problem is that most of
            these tools require you to upload your files to a remote server.
          </p>
          <p>
            When you upload sensitive PDFs, images of ID cards, signed contracts
            or internal reports, you are forced to trust a system you cannot
            see. You do not know how long files are kept, who has access, or
            whether copies end up in backups and logs. Even if a site promises
            that files are deleted after a few minutes, you have no way to audit
            that claim.
          </p>
          <p>
            NoUploadTools takes a simpler approach: keep the data on your
            device. Modern browsers are powerful enough to resize images,
            generate PDFs, encrypt files and more directly on your computer. Our
            tools use that power so your files never leave your machine.
          </p>
          <p>
            ...
            for e‑mail without constantly worrying about where the data is
            going. For highly sensitive material, that difference matters.
          </p>
          <p>
            Over time, NoUploadTools will grow into a small directory of
            focused, privacy‑first utilities. The goal is not to have hundreds
            of flashy features, but a short list of tools you can rely on every
            day.
          </p>
        </section>
